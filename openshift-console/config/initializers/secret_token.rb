...
if session_secret.blank?
  ...
  Broker::Application.config.secret_token = 'bc09e1f022b83b744a16e72d92dc2bb5b6778e1526617e5bee8e89c13e80edb208335823a456773827f62b3b91392f36c6c264006a49a2ed96baea9c7a599fd0'
else
  ...
  Broker::Application.config.secret_token = Digest::SHA512.hexdigest(session_secret)
end
